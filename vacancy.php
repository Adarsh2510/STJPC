...
<body>
 ...
 <div class="container" style="margin-bottom: 80px;">
  ...
  <tr>
  <th>Vacancy Type</th>	
  <th>Form Submission Deadline</th>
  <th>Form</th>
  </tr>
  <?php
...
if (!$query) {
  die ('SQL Error: ' . mysqli_error($conn));
     ...
     while ($row = mysqli_fetch_array($query)) {
      ...
      echo "<td><a href=\"".$row['form']."\">click to view</a></td>" ;
      echo "</tr>";
               }
       ?>
